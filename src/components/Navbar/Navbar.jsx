...
const Navbar = () => {
    const [isOpen, setIsOpen] = useState(false); // Mobile menu icons FIX and FI Menu
        ...
        ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"}`}>
            ...
            <div className="text-white py-5 flex justify-between items-center">
                ...
                <div className="text-lg font-semibold cursor-pointer">
                    ...
                    <span className="text-white">Prasadsing</span>
                    <span className="text-[#8245ec]">/</span>
                ...
                <div className="hidden md:flex space-x-4">
                    <a href="https://github.com/Prasadsing25"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-300 hover:text-[#8245ec]">
                        <FaGithub size={24} />
                    </a>
                    <a href="https://www.linkedin.com/in/prasadsing-solanki-0045ph275"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-300 hover:text-[#8245ec]">
                        <FaLinkedin size={24} />
